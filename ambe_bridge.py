...
class AMBE_BASE:
    def __init__(self, _parent, _name, _config, _logger, _port, pei):
                ...
                if (v):
                    ...
                    if (t == TAG_BEGIN_TX) or (t == TAG_SET_INFO):
                        ...
                        if ord(l) > 1:
                            ...
                            _rx_slot.rf_src = hex_str_3(self.pei.callerid)
    ...
    def begin_call(self, _slot, _src_id, _dst_id, _repeater_id, _cc, _seq, _stream_id):
        ...
        self.pei.call_start(_src_id, _repeater_id)
...
class AMBE_HB(AMBE_BASE):
    def __init__(self, _parent, _name, _config, _logger, _port, pei):
        AMBE_BASE.__init__(self, _parent, _name, _config, _logger, _port, pei)
        self.lcss = [
